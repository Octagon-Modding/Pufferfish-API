...
public enum SoundEventsHolder {
    ...
    public static SoundEvent getSoundEvent(SoundEventsHolder sound) {
        switch (sound) {
            ...
            case CAMEL_SADDLE -> {
                return SoundEvents.CAMEL_SADDLE.value();
            }
            case CAMEL_SIT -> {
            ...
            case PIG_SADDLE -> {
                return SoundEvents.PIG_SADDLE.value();
            }
            case PIG_STEP -> {
            ...
            case STRIDER_SADDLE -> {
                return SoundEvents.STRIDER_SADDLE.value();
            }
            ...
            case WOLF_ARMOR_BREAK -> {
                return SoundEvents.WOLF_ARMOR_BREAK.value();
            }
            ...
            case WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CLASSIC).growlSound().value();
            }
            case WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CLASSIC).hurtSound().value();
            }
            case WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CLASSIC).pantSound().value();
            }
            case WOLF_SHAKE -> {
            ...
            case WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CLASSIC).whineSound().value();
            }
            ...
            case PUGLIN_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).growlSound().value();
            }
            case PUGLIN_WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).hurtSound().value();
            }
            case PUGLIN_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).whineSound().value();
            }
            case PUGLIN_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).pantSound().value();
            }
            case PUGLIN_WOLF_DEATH -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).deathSound().value();
            }
            case PUGLIN_WOLF_AMBIENT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.PUGLIN).ambientSound().value();
            }
            case SAD_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).growlSound().value();
            }
            case SAD_WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).hurtSound().value();
            }
            case SAD_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).whineSound().value();
            }
            case SAD_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).pantSound().value();
            }
            case SAD_WOLF_DEATH -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).deathSound().value();
            }
            case SAD_WOLF_AMBIENT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.SAD).ambientSound().value();
            }
            case ANGRY_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.ANGRY).growlSound().value();
            }
            ...
            case ANGRY_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.ANGRY).whineSound().value();
            }
            case ANGRY_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.ANGRY).pantSound().value();
            }
            ...
            case GRUMPY_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.GRUMPY).growlSound().value();
            }
            case GRUMPY_WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.GRUMPY).hurtSound().value();
            }
            case GRUMPY_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.GRUMPY).whineSound().value();
            }
            case GRUMPY_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.GRUMPY).pantSound().value();
            }
            ...
            case BIG_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).growlSound().value();
            }
            case BIG_WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).hurtSound().value();
            }
            case BIG_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).whineSound().value();
            }
            case BIG_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).pantSound().value();
            }
            case BIG_WOLF_DEATH -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).deathSound().value();
            }
            case BIG_WOLF_AMBIENT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.BIG).ambientSound().value();
            }
            case CUTE_WOLF_GROWL -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CUTE).growlSound().value();
            }
            case CUTE_WOLF_HURT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CUTE).hurtSound().value();
            }
            case CUTE_WOLF_WHINE -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CUTE).whineSound().value();
            }
            case CUTE_WOLF_PANT -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CUTE).pantSound().value();
            }
            case CUTE_WOLF_DEATH -> {
                return SoundEvents.WOLF_SOUNDS.get(WolfSoundVariants.SoundSet.CUTE).deathSound().value();
            }
            ...
            case LEAF_LITTER_BREAK -> {
                return SoundEvents.LEAF_LITTER_BREAK;
            }
            case LEAF_LITTER_STEP -> {
                return SoundEvents.LEAF_LITTER_STEP;
            }
            case LEAF_LITTER_PLACE -> {
                return SoundEvents.LEAF_LITTER_PLACE;
            }
            case LEAF_LITTER_HIT -> {
                return SoundEvents.LEAF_LITTER_HIT;
            }
            case LEAF_LITTER_FALL -> {
                return SoundEvents.LEAF_LITTER_FALL;
            }
            case DEAD_BUSH_IDLE -> {
                return SoundEvents.DEAD_BUSH_IDLE;
            }
            case SAND_IDLE -> {
            ...
            case IRON_STEP -> {
                return SoundEvents.IRON_STEP;
            }
            case IRON_PLACE -> {
                return SoundEvents.IRON_PLACE;
            }
            case IRON_HIT -> {
                return SoundEvents.IRON_HIT;
            }
            case IRON_FALL -> {
                return SoundEvents.IRON_FALL;
            }
            case WOLF_HOWL, CAT_AMBIENT_BABY, CAT_STRAY_AMBIENT_BABY, CAT_DEATH_BABY, CAT_EAT_BABY, CAT_HISS_BABY,
                 CAT_BEG_FOR_FOOD_BABY, CAT_HURT_BABY, CAT_PURR_BABY, CAT_PURREOW_BABY, ROYAL_CAT_AMBIENT,
                 ROYAL_CAT_STRAY_AMBIENT, ROYAL_CAT_DEATH, ROYAL_CAT_EAT, ROYAL_CAT_HISS, ROYAL_CAT_BEG_FOR_FOOD,
                 ROYAL_CAT_HURT, ROYAL_CAT_PURR, ROYAL_CAT_PURREOW, ROYAL_CAT_AMBIENT_BABY, ROYAL_CAT_STRAY_AMBIENT_BABY,
                 ROYAL_CAT_DEATH_BABY, ROYAL_CAT_EAT_BABY, ROYAL_CAT_HISS_BABY, ROYAL_CAT_BEG_FOR_FOOD_BABY,
                 ROYAL_CAT_HURT_BABY, ROYAL_CAT_PURR_BABY, ROYAL_CAT_PURREOW_BABY, CHICKEN_AMBIENT_BABY, CHICKEN_DEATH_BABY,
                 CHICKEN_HURT_BABY, CHICKEN_STEP_BABY, MOODY_COW_AMBIENT, MOODY_COW_DEATH, MOODY_COW_HURT, MOODY_COW_STEP,
                 GOLDEN_DANDELION_USE, GOLDEN_DANDELION_UNUSE, HORSE_AMBIENT_BABY, HORSE_ANGRY_BABY, HORSE_BREATHE_BABY,
                 HORSE_DEATH_BABY, HORSE_EAT_BABY, HORSE_HURT_BABY, HORSE_LAND_BABY, HORSE_STEP_BABY, NOTE_BLOCK_TRUMPET,
                 NOTE_BLOCK_TRUMPET_EXPOSED, NOTE_BLOCK_TRUMPET_OXIDIZED, NOTE_BLOCK_TRUMPET_WEATHERED, PIG_STEP_BABY,
                 PIG_AMBIENT_BABY, PIG_EAT_BABY, PIG_HURT_BABY, PIG_DEATH_BABY, PICKY_CHICKEN_AMBIENT_BABY,
                 PICKY_CHICKEN_DEATH_BABY, PICKY_CHICKEN_HURT_BABY, PICKY_CHICKEN_STEP_BABY, PICKY_CHICKEN_AMBIENT,
                 PICKY_CHICKEN_DEATH, PICKY_CHICKEN_HURT, PICKY_CHICKEN_STEP, MINI_PIG_STEP_BABY, MINI_PIG_AMBIENT_BABY,
                 MINI_PIG_EAT_BABY, MINI_PIG_HURT_BABY, MINI_PIG_DEATH_BABY, MINI_PIG_STEP, MINI_PIG_AMBIENT, MINI_PIG_EAT,
                 MINI_PIG_HURT, MINI_PIG_DEATH, BIG_PIG_STEP_BABY, BIG_PIG_AMBIENT_BABY, BIG_PIG_EAT_BABY, BIG_PIG_HURT_BABY,
                 BIG_PIG_DEATH_BABY, BIG_PIG_STEP, BIG_PIG_AMBIENT, BIG_PIG_EAT, BIG_PIG_HURT, BIG_PIG_DEATH,
                 WOLF_AMBIENT_BABY, WOLF_DEATH_BABY, WOLF_GROWL_BABY, WOLF_HURT_BABY, WOLF_PANT_BABY, WOLF_STEP_BABY,
                 WOLF_WHINE_BABY, PUGLIN_WOLF_GROWL_BABY, PUGLIN_WOLF_HURT_BABY, PUGLIN_WOLF_WHINE_BABY, PUGLIN_WOLF_PANT_BABY,
                 PUGLIN_WOLF_DEATH_BABY, PUGLIN_WOLF_AMBIENT_BABY, SAD_WOLF_GROWL_BABY, SAD_WOLF_HURT_BABY,
                 SAD_WOLF_WHINE_BABY, SAD_WOLF_PANT_BABY, SAD_WOLF_DEATH_BABY, SAD_WOLF_AMBIENT_BABY, ANGRY_WOLF_GROWL_BABY,
                 ANGRY_WOLF_HURT_BABY, ANGRY_WOLF_WHINE_BABY, ANGRY_WOLF_PANT_BABY, ANGRY_WOLF_DEATH_BABY,
                 ANGRY_WOLF_AMBIENT_BABY, GRUMPY_WOLF_GROWL_BABY, GRUMPY_WOLF_HURT_BABY, GRUMPY_WOLF_WHINE_BABY,
                 GRUMPY_WOLF_PANT_BABY, GRUMPY_WOLF_DEATH_BABY, GRUMPY_WOLF_AMBIENT_BABY, BIG_WOLF_GROWL_BABY,
                 BIG_WOLF_HURT_BABY, BIG_WOLF_WHINE_BABY, BIG_WOLF_PANT_BABY, BIG_WOLF_DEATH_BABY, BIG_WOLF_AMBIENT_BABY,
                 CUTE_WOLF_GROWL_BABY, CUTE_WOLF_HURT_BABY, CUTE_WOLF_WHINE_BABY, CUTE_WOLF_PANT_BABY, CUTE_WOLF_DEATH_BABY,
                 CUTE_WOLF_AMBIENT_BABY, PIG_EAT, ARMOR_EQUIP_NAUTILUS, ARMOR_UNEQUIP_NAUTILUS, BABY_NAUTILUS_AMBIENT,
                 BABY_NAUTILUS_AMBIENT_ON_LAND, BABY_NAUTILUS_DEATH, BABY_NAUTILUS_DEATH_ON_LAND, BABY_NAUTILUS_EAT,
                 BABY_NAUTILUS_HURT, BABY_NAUTILUS_HURT_ON_LAND, NAUTILUS_RIDING, BABY_NAUTILUS_SWIM, CAMEL_HUSK_AMBIENT,
                 CAMEL_HUSK_DASH, CAMEL_HUSK_DASH_READY, CAMEL_HUSK_DEATH, CAMEL_HUSK_EAT, CAMEL_HUSK_HURT, CAMEL_HUSK_SADDLE,
                 CAMEL_HUSK_SIT, CAMEL_HUSK_STAND, CAMEL_HUSK_STEP, CAMEL_HUSK_STEP_SAND, LUNGE_1, LUNGE_2, LUNGE_3,
                 NAUTILUS_AMBIENT, NAUTILUS_AMBIENT_ON_LAND, NAUTILUS_DASH, NAUTILUS_DASH_ON_LAND, NAUTILUS_DASH_READY,
                 NAUTILUS_DASH_READY_ON_LAND, NAUTILUS_DEATH, NAUTILUS_DEATH_ON_LAND, NAUTILUS_EAT, NAUTILUS_HURT,
                 NAUTILUS_HURT_ON_LAND, NAUTILUS_SWIM, PARCHED_AMBIENT, PARCHED_DEATH, PARCHED_HURT, PARCHED_STEP,
                 PARROT_IMITATE_CAMEL_HUSK, PARROT_IMITATE_PARCHED, PARROT_IMITATE_ZOMBIE_HUSK, PARROT_IMITATE_ZOMBIE_NAUTILUS,
                 SPEAR_USE, SPEAR_HIT, SPEAR_ATTACK, SPEAR_WOOD_USE, SPEAR_WOOD_HIT, SPEAR_WOOD_ATTACK, ZOMBIE_HORSE_EAT,
                 ZOMBIE_NAUTILUS_AMBIENT, ZOMBIE_NAUTILUS_AMBIENT_ON_LAND, ZOMBIE_NAUTILUS_DASH, ZOMBIE_NAUTILUS_DASH_ON_LAND,
                 ...
                 WEATHER_END_FLASH, DRIED_GHAST_BREAK, DRIED_GHAST_STEP, DRIED_GHAST_FALL, DRIED_GHAST_AMBIENT,
                 DRIED_GHAST_AMBIENT_WATER, DRIED_GHAST_PLACE, DRIED_GHAST_PLACE_IN_WATER, DRIED_GHAST_TRANSITION,
                 GHASTLING_AMBIENT, GHASTLING_DEATH, GHASTLING_HURT, GHASTILING_SPAWN, HAPPY_GHAST_AMBIENT, HAPPY_GHAST_DEATH,
                 HAPPY_GHAST_HURT, HAPPY_GHAST_RIDING, HAPPY_GHAST_EQUIP, HAPPY_GHAST_UNEQUIP, HAPPY_GHAST_GOGGLES_UP,
                 HAPPY_GHAST_GOGGLES_DOWN, HORSE_ARMOR_UNEQUIP, LLAMA_CARPET_UNEQUIP, MUSIC_DISC_LAVA_CHICKEN, MUSIC_DISC_TEARS,
                 SHEARS_SNIP, SADDLE_UNEQUIP -> {
