...
public enum SoundEventsHolder {
    ...
    public static SoundEvent getSoundEvent(SoundEventsHolder sound) {
        switch (sound) {
            ...
            case MUSIC_DISC_13 -> {
                return SoundEvents.MUSIC_DISC_13;
            }
            case MUSIC_DISC_BLOCKS -> {
                return SoundEvents.MUSIC_DISC_BLOCKS;
            }
            case MUSIC_DISC_CAT -> {
                return SoundEvents.MUSIC_DISC_CAT;
            }
            case MUSIC_DISC_CHIRP -> {
                return SoundEvents.MUSIC_DISC_CHIRP;
            }
            case MUSIC_DISC_FAR -> {
                return SoundEvents.MUSIC_DISC_FAR;
            }
            case MUSIC_DISC_MALL -> {
                return SoundEvents.MUSIC_DISC_MALL;
            }
            case MUSIC_DISC_MELLOHI -> {
                return SoundEvents.MUSIC_DISC_MELLOHI;
            }
            ...
            case MUSIC_DISC_WAIT -> {
                return SoundEvents.MUSIC_DISC_WAIT;
            }
            ...
            case MUSIC_DISC_RELIC -> {
                return SoundEvents.MUSIC_DISC_RELIC;
            }
            case MUSIC_DRAGON -> {
            ...
            case CREAKING_DEACTIVATE, CREAKING_ATTACK, CREAKING_DEATH, CREAKING_STEP, CREAKING_FREEZE,
                 ...
                 CREAKING_ACTIVATE, BUNDLE_INSERT_FAIL, TRIAL_SPAWNER_OMINOUS_ACTIVATE,
                 TRIAL_SPAWNER_AMBIENT_OMINOUS, MUSIC_DISC_CREATOR, MUSIC_DISC_CREATOR_MUSIC_BOX,
                 MUSIC_DISC_PRECIPICE, VAULT_REJECT_REWARDED_PLAYER, PUGLIN_WOLF_AMBIENT, PUGLIN_WOLF_DEATH,
