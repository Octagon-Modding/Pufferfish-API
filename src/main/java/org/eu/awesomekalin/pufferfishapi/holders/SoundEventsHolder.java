...
public enum SoundEventsHolder {
    ...
    public static SoundEvent getSoundEvent(SoundEventsHolder sound) {
        switch (sound) {
            ...
            case PUGLIN_WOLF_AMBIENT, PUGLIN_WOLF_DEATH, PUGLIN_WOLF_GROWL, PUGLIN_WOLF_HURT, PUGLIN_WOLF_PANT,
                 PUGLIN_WOLF_WHINE, SAD_WOLF_AMBIENT, SAD_WOLF_DEATH, SAD_WOLF_GROWL, SAD_WOLF_HURT, SAD_WOLF_PANT,
                 SAD_WOLF_WHINE, ANGRY_WOLF_AMBIENT, ANGRY_WOLF_DEATH, ANGRY_WOLF_GROWL, ANGRY_WOLF_HURT, ANGRY_WOLF_PANT,
                 ANGRY_WOLF_WHINE, GRUMPY_WOLF_AMBIENT, GRUMPY_WOLF_DEATH, GRUMPY_WOLF_GROWL, GRUMPY_WOLF_HURT,
                 GRUMPY_WOLF_PANT, GRUMPY_WOLF_WHINE, BIG_WOLF_AMBIENT, BIG_WOLF_DEATH, BIG_WOLF_GROWL, BIG_WOLF_HURT,
                 BIG_WOLF_PANT, BIG_WOLF_WHINE, CUTE_WOLF_AMBIENT, CUTE_WOLF_DEATH, CUTE_WOLF_GROWL, CUTE_WOLF_HURT,
                 CUTE_WOLF_PANT, CUTE_WOLF_WHINE, FIREFLY_BUSH_IDLE, LEAF_LITTER_BREAK, LEAF_LITTER_STEP, LEAF_LITTER_PLACE,
                 LEAF_LITTER_HIT, LEAF_LITTER_FALL, DEAD_BUSH_IDLE, SAND_IDLE, SAND_WIND, IRON_BREAK, IRON_STEP, IRON_PLACE,
                 IRON_HIT, IRON_FALL, CAT_AMBIENT_BABY, CAT_STRAY_AMBIENT_BABY, CAT_DEATH_BABY, CAT_EAT_BABY, CAT_HISS_BABY,
