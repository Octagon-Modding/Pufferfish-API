...
public enum SoundEventsHolder {
    ...
    public static SoundEvent getSoundEvent(SoundEventsHolder sound) {
        switch (sound) {
            ...
            case PUGLIN_WOLF_AMBIENT, PUGLIN_WOLF_DEATH, PUGLIN_WOLF_GROWL, PUGLIN_WOLF_HURT,
                 PUGLIN_WOLF_PANT, PUGLIN_WOLF_WHINE, SAD_WOLF_AMBIENT, SAD_WOLF_DEATH,
                 SAD_WOLF_GROWL, SAD_WOLF_HURT, SAD_WOLF_PANT, SAD_WOLF_WHINE,
