...
public class ChestScreen extends AbstractContainerScreen<@NotNull ChestMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float v, int i, int i1) {
        ...
        guiGraphics.blit(RenderType.GUI, chestSettings.guiTexture.convertToMinecraftIdentifier(), x, y, 0, 0, imageWidth, imageHeight, this.chestSettings.screenWidth, this.chestSettings.screenHeight);
    }
