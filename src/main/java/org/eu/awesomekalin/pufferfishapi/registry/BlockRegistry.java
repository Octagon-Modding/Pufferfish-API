...
public class BlockRegistry {
    ...
    public BlockRegistryHolder registerChest(String name, BlockProperties blockProperties, ChestSettings chestSettings) {
        final Block chestBlock = Registry.register(BuiltInRegistries.BLOCK, Identifier.fromNamespaceAndPath(this.modId, name), new CustomChestBlock(blockProperties.getProperties(Identifier.fromNamespaceAndPath(this.modId, name)), this::getBlockEntityRenderers, blockEntityRenderers.size(), chestSettings));
